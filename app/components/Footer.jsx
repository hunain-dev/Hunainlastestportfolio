...
const Footer = () => {
  ...
  return (
    <div className="min-h-full mt-26 w-full">
      ...
      <div className="relative flex">
        ...
        <div className=" w-full  mx-auto  grid grid-cols-2">
          <div className="actay w-full    h-full  px-3 py-3">
            ...
            <h2 className="uppercase text-lg">A 881, Phase 1, Gulshan e hadeed</h2>
            <h2 className="uppercase text-lg">Huniiali1122@gmail.com</h2>
               
               <div className="h-full mt-6 w-fit">
               <Button  btntext="Contact us"  link="/work" classname="uppercase px-15 py-2 bg-[#FFD900]"  />
