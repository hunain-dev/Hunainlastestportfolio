...
const LandingHero = () => {
  ...
  return (
    <div className='min-full mb-7 w-full flex items-center justify-start flex-col'>
        ...
        <h1 className='Fontspring uppercase text-5xl '>{`Hi I’am Muhammad Hunain`}</h1>
        <h4 className='ActayCondensed text-2xl'>Your product designer and developer partner!</h4>
        </div>
